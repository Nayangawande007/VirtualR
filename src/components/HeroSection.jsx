...
function HeroSection() {
  return (
    <div className='flex flex-col item-center mt-6 lg:mt-20'>
        ...
        <p className='mt-10 text-lg text-center justify-center ml-36 text-neutral-500 max-w-4xl'>
            Empower your creativity and bring your VR app ideas to  life with our
           intuitive development tools. Get staarted today and turn your imagination 
